...
class AuditService
{
     ...
     * Log an audit event.
     *
     * @param  array<string, string|int|float|bool|* @method static \App\Models\Brand create(array<string, string|bool|null>|null  $oldValues
     * @param  array<string, string|int|float|bool|* @method static \App\Models\Brand create(array<string, string|bool|null>|null  $newValues
     ...
     * Log model update.
     *
     * @param  array<string, string|int|float|bool|* @method static \App\Models\Brand create(array<string, string|bool|null>  $oldValues
     * @param  array<string, string|int|float|bool|* @method static \App\Models\Brand create(array<string, string|bool|null>|null  $metadata
     */
