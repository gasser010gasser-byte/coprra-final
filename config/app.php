...
use App\Providers\CompressionServiceProvider;
...
return [
    ...
    */
    ...
    // Removed duplicate timezone/locale/fallback/faker keys at bottom. This is the canonical set.
    'timezone' => 'UTC',
    ...
    */
    ...
    // Legacy providers array (kept for backward compatibility in some tools). Use defaultProviders() below.
    'providers' => [
        ...
        LogProcessingServiceProvider::class,
    ...
    */
    ...
    // Legacy aliases array (kept for backward compatibility in some tools). Use Facade::defaultAliases() below.
    'aliases' => [
    ...
    */
    ...
    // Removed duplicate providers definition; using legacy 'providers' array above
